...
Внутри kit'а есть composable `useTheme()` (см. фазу 0 в [ROADMAP](../internal/roadmap.md)), который инкапсулирует чтение/запись атрибута и подписку на системные изменения.
